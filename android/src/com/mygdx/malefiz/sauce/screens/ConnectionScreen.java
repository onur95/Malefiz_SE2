...
public class ConnectionScreen implements Screen {
    ...
    public ConnectionScreen(final Malefiz game){
        ...
        imageButtonConnect= com.mygdx.malefiz.sauce.screens.MainMenuScreen.createImageButton("connect.png",375,335,350,150);
        imageButtonReturn= com.mygdx.malefiz.sauce.screens.MainMenuScreen.createImageButton("return.png",380,220,350,150);
    ...
    public void show() {
        ...
        imageButtonReturn.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y){
                ...
                game.setScreen(new com.mygdx.malefiz.sauce.screens.MainMenuScreen(game));
            }
        });
